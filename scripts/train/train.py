...
def main():
    ...
    parser.add_argument("--label_noise", type=float, help="Amount of label noise in training mode 'fixed_noise.")
    ...
    sdec = SDECPipeline()
    sdec.train_model(args.model_name, args.training_mode, args.num_labels, args.label_noise, args.dataset_type, args.santa_barbara_path)
