...
def main():
    ...
    parser.add_argument("--training_mode", choices=["no_noise", "fixed_noise", "scheduled_noise"], help="Training mode setting noise in concatenated labels.")
    parser.add_argument("--perturbation_mode", choices=["random", "overlap"], help="Type of label perturbation.")
    ...
    sdec = SDECPipeline()
    sdec.train_model(args.model_name, args.num_labels, args.dataset_type, args.training_mode, args.perturbation_mode, args.token_noise, args.label_noise, args.santa_barbara_path)
