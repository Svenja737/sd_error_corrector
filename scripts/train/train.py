...
def main():
    ...
    parser.add_argument("--token_noise", default=False, help="Inject noise into tokens as well as labels.")
    parser.add_argument("--binary", default=False, help="True if speaker labels are binary, False otherwise. (default: False)")
    ...
    sdec = SDECPipeline()
    print(f"Token Noise train.py: {args.token_noise}")
    sdec.train_model(args.model_name, args.num_labels, args.dataset_type, args.training_mode, args.binary, args.label_noise, args.token_noise, args.santa_barbara_path)
